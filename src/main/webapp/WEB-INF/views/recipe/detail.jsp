				...
				<tbody>
					<tr>
						<td class="text-center" colspan="3">
							<img :src="store.detail.vo.poster" style="width: 800px;heigth: 250px">
						</td>
					</tr>
					<tr>
						<td class="text-center" colspan="3">
					...
					<tr>
						...
						<button type="button" class="btn-sm btn-danger">예약(FullCalendar)</button>
			...
			<table class="table">
				<tbody>
					...
					<tr v-for="(data,index) in store.detail.tList">
						...
						<td class="text-right" width="15%"><img :src="store.detail.iList[index]" style="width: 180px;height: 60px;"></td>
					</tr>
				</tbody>
			</table>
			<table class="table">
								...
								<tbody>
									<tr>
										...
										<td class="text-right">
											...
											@click="rStore.toggleUpdate(rvo.no,rvo.msg)">{{rStore.upReplyNo===rvo.no?'취소':'수정'}}</button>
											<button class="btn-xs btn-warning" v-if="rStore.sessionId===rvo.id"
											@click="rStore.replyDelete(rvo.no)">삭제</button>
										</td>
									</tr>
									<tr>
									...
									<tr>
										<td colspan="2" class="text-left" v-if="rStore.upReplyNo===rvo.no">
											...
											<button type="button" class="btn-success" style="width: 100px;height: 102px;float: left"
											 @click="rStore.replyUpdate(rvo.no)">댓글수정</button>
										</td>
									</tr>
								</tbody>
							</table>
				...
				<tbody>
					<tr>
						<td>
							...
							<button type="button" class="btn-success" style="width: 100px;height: 102px;float: left" @click="rStore.replyInsert()">댓글쓰기</button>
						</td>
					</tr>
				</tbody>
			</table>
